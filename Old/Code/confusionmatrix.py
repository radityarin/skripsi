...
class ConfusionMatrix(object):
    ...
    def get_accuracy_each_class(self):
        accuracy_each_class = []
    ...
    def get_precision_each_class(self):
        ...
        return precision_each_class

    def get_recall_each_class(self):
        recall_each_class = []
        ...
        return recall_each_class

    def get_fmeasure_each_class(self):
        precision_each_class = self.get_precision_each_class()
        recall_each_class = self.get_recall_each_class()
        fmeasure_each_class = []
        fmeasure_each_class.append((2 * precision_each_class[0] * recall_each_class[0])/(precision_each_class[0]+recall_each_class[0]))
        fmeasure_each_class.append((2 * precision_each_class[1] * recall_each_class[1])/(precision_each_class[1]+recall_each_class[1]))
        fmeasure_each_class.append((2 * precision_each_class[2] * recall_each_class[2])/(precision_each_class[2]+recall_each_class[2]))
        return fmeasure_each_class

    def score(self, actual, predicted):
        self.actual = actual
        self.create_confusion_matrix(actual,predicted)
        self.find_tp_fn_fp_tn()
        return self.get_accuracy(),self.get_accuracy_each_class(),self.get_precision_each_class(),self.get_recall_each_class(),self.get_fmeasure_each_class()
