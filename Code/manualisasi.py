...
stopwords_tbrs_manualisasi = ['online','daring','yang','saja','tetap','mau','offline','aku','materi','ada','ini','kelas','cara','sama','jadi','kasih','tapi','lebih','kalau','dosen','beberapa','kenapa','new','normal','zona','lagi','sendiri','dengan','masih','jujur','corona','paham','sekali','nilai','bisa','ya','selesai','jelas','mohon','kaji']			
...
nb.fit(new_cleaned_data,new_terms,data_target,stopwords_tbrs_manualisasi,tfidf)
